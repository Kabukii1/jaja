...
<main class="CBody">
    ...
    <div class="button-container">
        ...
        <article class="AUart">
            ...
            <img src="../Pics/juansumulong.jpeg" alt="Juan Sumulong">
              </div>
                <!-- Slide 2 -->
              <div class="swiper-slide">
            <img src="../Pics/joseabad.jpeg" alt="Jose Abad">
             </div>
                <!-- Slide 3 -->
              <div class="swiper-slide">
            <img src="../Pics/apolinario.jpeg" alt="Apolinario">
            </div>
                <!-- Slide 4 -->
             <div class="swiper-slide">
            <img src="../Pics/andres.jpeg" alt="Andres">
             </div>
               <!-- Slide 5 -->
             <div class="swiper-slide">
            <img src="../Pics/plaridel.jpeg" alt="Plaridel">
            </div>
              <!-- Slide 6 -->
             <div class="swiper-slide">
            <img src="../Pics/esguerra.jpeg" alt="Esguerra">
         </div>
              <!-- Slide 7 -->
           <div class="swiper-slide">
            <img src="../Pics/joserizal.jpeg" alt="Jose Rizal">
           </div>
         </div>
                <!-- Dots Pagination -->
...
<div class="awards-container">
    <div class="award-item">
        <img src="../Pics/shaping.jpeg" alt="Shaping">
        <p><strong>Guiding Students, Shaping Futures</strong></p>
    </div>
    <div class="award-item">
        <img src="../Pics/beyond.jpeg" alt="Beyond">
        <p><strong>Beyond Academics: We Care</strong></p>
    </div>
    <div class="award-item">
        <img src="../Pics/guidance.jpeg" alt="Guidance">
